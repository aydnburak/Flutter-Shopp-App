    ...
    return Expanded(
      child: Container(
        decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                  color: DefaultElements.knavbariconcolor, offset: Offset(0, -1), blurRadius: 2),
            ]),
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "Koşu ayakkabısı,Nike'ın Rahat ayakkabılarından",
                style: TextStyle(
                  fontSize: 18,
                  color: DefaultElements.kprimarycolor,
                ),
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    color: selectedColorIndex == index
                                        ? DefaultElements.kshoerepplecolorOptions[index]
                                        : Colors.white,
                                  ),
                                  child: Padding(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        shape: BoxShape.circle,
                                        color: DefaultElements.kshoecolorOptions[index],
                                      ),
                                    ),
                                  ),
                                ),
